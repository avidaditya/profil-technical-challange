                ...
                <div class="flex flex-wrap justify-center text-center">
                    <div class="w-full lg:w-10/12 px-4">
                        <h2 class="text-2xl font-semibold leading-tight md:text-4xl">
                            Omnis idea simplex potest fieri fons magnae virtutis quae afficit multa milia hominum
                        </h2>
                        {{-- <div>
                        ...
                        <p class="text-base md:text-lg lg:text-lg leading-relaxed m-4 text-gray-600">
                            Unum consilium fortasse non sufficit, tamen cum coniunctum est, solutio integra ad superandas difficultates complexas fit, etiam in inspirationis eruptionem quae excitare potest animos mutationis positivae.
                        </p>
                    </div>
                </div>
            </div>
